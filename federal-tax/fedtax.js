...
const calulateTax = function(married, allowanceIncrement, grossIncome) {
    ...
    // when gross income is less than 0
    if (grossIncome <= 0) {
        return 0;
    }
    ...
    for (var i = 0; i < brackets.length; i++) {
        ...
        if (brackets[i] > grossIncome) {
            ...
            return topBracket.percentage * (grossIncome - brackets[i - 1]) + topBracket.base; // Taxable income * Tax Rate + Base Tax, per IRS Circular E table 5
        }
    }
